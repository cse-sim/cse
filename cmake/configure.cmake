...
execute_process(COMMAND ${CMAKE_COMMAND} ${CMAKE_CURRENT_SOURCE_DIR} -T v142,version=14.29.16.11 -A ${ARCHBUILDFLAG} -DCMAKE_SYSTEM_VERSION=10.0.20348.0 -DCSEARCHBUILDFLAG=${ARCHBUILDFLAG}
