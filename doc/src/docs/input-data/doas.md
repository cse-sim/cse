...
default: "derived from _oaSupFanShaftBhp_ if given, else 0.08",
required: "No",
variability: "constant") %>

**oaSupFanShaftBhp=_float_**
...
units: "bhp",
legal_range: "_x_ $>$ 0",
default: "derived from _oaSupFanEff_.",
required: "No",
variability: "constant") %>
...
units: "",
legal_range: "0 $\\le$ _x_ $\\le$ 1",
default: "derived from _oaExhFanShaftBhp_ if given, else 0.08",
required: "No",
variability: "constant") %>

**oaExhFanShaftBhp=_float_**
...
units: "bhp",
legal_range: "_x_ $>$ 0",
default: "derived from _oaExhFanEff_.",
required: "No",
variability: "constant") %>
