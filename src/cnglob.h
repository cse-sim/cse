...
// types for tdpak defined here re uses in e.g. cnrecs.def
typedef time_t LDATETIME;
struct IDATE { SI year; SI month; SI mday; SI wday; };

typedef SI RC;		// Return Code explanations on the return code section
...
namespace Kiva { class Aggregator; class Foundation; }
