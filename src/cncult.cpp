...
// note: znArea/znVol required, see runtime check
	...
	CULT( "znRsys",	     DAT,   ZI( RSI),        0,        0, VEOI,   TYREF, &RSiB,  0.f,        N,   N),
	CULT( "znLoadMtr",   DAT,   ZI( LOADMTRI),   0,        0, VEOI,   TYREF, &LdMtriB, 0.f,      N,   N),
...
// zone subobjects
	CULT( "surface",     RATE,  0,               0,        0, 0,      0,     &SfiB,  0.f,     sfT,   N),
	CULT( "perimeter",   RATE,  0,               0,        0, 0,      0,     &PriB,  0.f,    perT,   N),
	CULT( "terminal",    RATE,  0,               0,        0, 0,      0,     &TuiB,  0.f,     tuT,   N),
	CULT( "gain",        RATE,  0,               0,        0, 0,      0,     &GniB,  0.f,     gnT,   N),
	CULT( "endZone",     ENDER, 0,               0,        0, 0,      0,     0,      0.f,       N,   N),
	CULT()
};	// znT
#undef ZI
#undef XFAN
...
CULT( "oaLoadMtr",   	DAT,   DOAS_LOADMTRI,	 0,   0, VEOI,	 TYREF, &LdMtriB, 0.f,      N,   N),
...
CULT( "rsElecMtr",   DAT,   RSYS_ELECMTRI,   0,       0, VEOI,	 TYREF, &MtriB, 0,      N,   N),
CULT( "rsFuelMtr",   DAT,   RSYS_FUELMTRI,   0,       0, VEOI,	 TYREF, &MtriB, 0,      N,   N),
CULT( "rsLoadMtr",   DAT,   RSYS_LOADMTRI,   0,       0, VEOI,	 TYREF, &LdMtriB, 0,      N,   N),
CULT( "rsSrcSideLoadMtr", DAT, RSYS_SRCSIDELOADMTRI, 0,0,VEOI,	 TYREF, &LdMtriB, 0,      N,   N),
...
CULT( "ductSeg",     RATE,  0,               0,       0, 0,      0,     &DsiB,  0.f,      dsT, N),
...
CULT( "dhwuse",      RATE,  0,                 0,       0, 0,      0,     &WUiB,  0.f,      dhwUseT, N),
...
CULT( "whElecMtr",   DAT,   DHWHEATER_ELECMTRI,0,     0, VEOI,	 TYREF, &MtriB, 0.f,      N, N),
CULT( "whFuelMtr",   DAT,   DHWHEATER_FUELMTRI,0,     0, VEOI,	 TYREF, &MtriB, 0.f,      N,   N),
...
CULT( "wpElecMtr",   DAT,   DHWPUMP_ELECMTRI,  0,     0, VEOI,	 TYREF,   &MtriB, 0,      N, N),
...
CULT( "dhwloopBranch", RATE,0,                  0,      0, 0,      0,     &WBiB,  0.f,      dhwLoopBranchT, N),
...
CULT( "wlpElecMtr",  DAT,   DHWLOOPPUMP_ELECMTRI, 0,     0, VEOI,  TYREF,   &MtriB, 0,      N, N),
...
CULT( "wlElecMtr",   DAT,   DHWLOOP_ELECMTRI,  0,       0, VEOI,   TYREF,   &MtriB, 0,      N, N),
CULT( "dhwloopSeg",  RATE,  0,                 0,       0, 0,      0,     &WGiB,  0,      dhwLoopSegT, N),
CULT( "dhwloopPump", RATE,  0,                 0,       0, 0,      0,     &WLPiB, 0,      dhwLoopPumpT, N),
...
CULT( "wsCentralDHWSYS",DAT,DHWSYS_CENTRALDHWSYSI,0,  0, VEOI,   TYREF, &WSiB,  0,      N, N),
CULT( "wsLoadShareDHWSYS",DAT,DHWSYS_LOADSHAREDHWSYSI,0,0,VEOI,  TYREF, &WSiB,  0,      N, N),
...
CULT( "wsDayUse",    DAT,   DHWSYS_DAYUSENAME,0,      0, VDAILY, TYSTR, 0,      0.f,      N, N),
CULT( "wsWHhwMtr",   DAT,   DHWSYS_WHHWMTRI, 0,       0, VEOI,	 TYREF, &WMtriB,0.f,      N, N),
CULT( "wsFXhwMtr",   DAT,   DHWSYS_FXHWMTRI, 0,       0, VEOI,	 TYREF, &WMtriB,0.f,      N, N),
CULT( "wsParElec",	 DAT,   DHWSYS_PARELEC,  0,       0, VHRLY,  TYFL,  0,      0.f,    N, N),
CULT( "wsSolarSys",  DAT,   DHWSYS_SWTI,     0,       0, VEOI,	 TYREF, &SWHiB,	0.f,      N, N),
...
CULT( "wsElecMtr",   DAT,   DHWSYS_ELECMTRI, 0,       0, VEOI,	 TYREF, &MtriB, 0.f,      N, N),
CULT( "wsFuelMtr",   DAT,   DHWSYS_FUELMTRI, 0,       0, VEOI,	 TYREF, &MtriB, 0.f,      N, N),
CULT( "wsWriteDrawCSV",DAT, DHWSYS_DRAWCSV,  0,       0, VEOI,   TYCH,  0,      C_NOYESCH_NO, N, N),
CULT( "dhwheater",   RATE,  0,               0,       0, 0,      0,     &WHiB,  0.f,      dhwHeaterT, N),
CULT( "dhwloopheater",RATE, 0,               0,       0, 0,      0,     &WLHiB, 0.f,      dhwHeaterT, N),
CULT( "dhwtank",     RATE,  0,               0,       0, 0,      0,     &WTiB,  0.f,      dhwTankT, N),
CULT( "dhwpump",     RATE,  0,               0,       0, 0,      0,     &WPiB,  0.f,      dhwPumpT, N),
CULT( "dhwloop",     RATE,  0,               0,       0, 0,      0,     &WLiB,  0.f,      dhwLoopT, N),
CULT( "dhwheatrec",  RATE,  0,               0,       0, 0,      0,     &WRiB,  0.f,      dhwHeatRecT, N),
...
CULT( "swElecMtr",   DAT,      DHWSOLARSYS_ELECMTRI,       0,  0, VEOI,   TYREF, &MtriB, 0.f,      N, N),
...
CULT( "swTankZone",   DAT,     DHWSOLARSYS_TANKZNTI,       0,  0, VEOI,   TYREF, &ZiB,   0.f,      N, N),
CULT( "swTankTEx",   DAT,      DHWSOLARSYS_TANKTEX,        0,  0, VHRLY,  TYFL,  0,      0.f,    N, N),
CULT( "dhwsolarcollector",RATE,0,                          0,  0, 0,         0,  &SCiB,  0.f,     dhwSolColT, N),
...
CULT( "pvElecMtr",   DAT,   PVARRAY_ELECMTRI,  0,     0, VEOI,   TYREF, &MtriB, 0.f,      N, N),
...
CULT( "btMeter",      DAT,   BATTERY_METER,   0,       0, VEOI,   TYREF, &MtriB, 0.f,      N,   N),
...
// TOP report page formatting
	...
	CULT( "repTestPfx",  DAT,   TOPRAT_REPTESTPFX, 0,          0, VEOI,   TYSTR, 0,      0,            N,   N),
