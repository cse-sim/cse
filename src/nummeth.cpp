...
#if 0
///////////////////////////////////////////////////////////////////////////////
// Directed graph and associated topological sort
///////////////////////////////////////////////////////////////////////////////
...
public:
	DGRAPH() : dg_nV{ 0 } {};
	int dg_Size() const { return dg_adj.size(); }
	void dg_Clear() { dg_adj.clear(); dg_nV = 0; }
	void dg_AddEdge(int iV, int iW);
	void dg_TopologicalSort();

private:
	int dg_nV;	// # of verticies
	std::vector< std::list<int>> dg_adj;
	void dg_topologicalSortUtil(int v, bool visited[], std::stack<int>& stack);
};		// class DGRAPH

void DGRAPH::dg_AddEdge(
	int iV,		// vertex
	int iW)		// 
{
	if (iV > dg_Size())
	...
	dg_adj[ iV].push_back(iW); // add iW to iV's list
}		// DGRAPH::dg_AddEdge
//-------------------------------------------------------------------------
