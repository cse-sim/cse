...
SEC    FC xfread( XFILE* xf, char *, USI);
SEC    CDEC xfprintf( XFILE* xf, const char *, ... );
SEC    FC xfwrite( XFILE* xf, const char* buf, size_t nbytes);
SEC    FC xftell( XFILE* xf, long* fPos);
SEC    FC xfseek( XFILE* xf, long disp, int mode);
SEC    FC xfsize( XFILE* xf, uintmax_t* psize);
SEC    FC xlsterr( XFILE* xf);
