...
{
	rs_perfMapAccessHtg.pa_Clear();		// insurance: PMACCESS not copyable
	rs_perfMapAccessClg.pa_Clear();
	rs_desc.Release();
...
#if defined( RSYSPM)
			float capClg, inpClg;
			/* RC rc = */ rs_perfMapAccessClg.pa_GetCapInp( rs_tdbOut, rs_speedF,
				capClg, inpClg);
			rs_speedFMin = rs_perfMapAccessClg.pa_GetSpeedFMin();
#else
